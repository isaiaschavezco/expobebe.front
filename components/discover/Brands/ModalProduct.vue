<template>
  ...
  <Modal v-if="true" :is-modal-visible="true" @click="this.closeFunction">
    ...
    >
      <BotonClose color="text-graycorp" class="mr-2" :funcion="this.closeFunction" />
      ...
      <div class="body_cardproduct w-100 flex flex-col md:flex-row">
        <div
          ...
          class="md:h-full box-border img_cardproduct--container w-full md:w-3/6 flex justify-center"
        >
          <div class="precarga img_cardproduct relative overflow-hidden w-11/12">
            ...
            />
            <!--
              esto es el 360 por si se llega a reutilizar
              las animaciones que aparecen son por si eso sucede también
            <img
        ...
        <div
          ...
          class="text__cardproduct break-words text-xs md:text-sm lg:text-lg object-cover h-full box-border w-full md:w-2/6 mx-auto invisible-scrollbar overflow-y-scroll"
        >
